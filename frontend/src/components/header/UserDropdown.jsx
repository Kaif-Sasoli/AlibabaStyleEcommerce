  ...
  return (
    ...
    >
      ...
      `}>
        {user ? (
          <div>
            <p className="px-4 font-semibold text-lg mb-2">Hi, {user.name}</p>
            <ul className="space-y-2 text-sm">
              ...
              <li className="py-1 px-4 text-base cursor-pointer hover:bg-red-50 text-red-500 hover:font-semibold">
                Logout
              </li>
            </ul>
          </div>
