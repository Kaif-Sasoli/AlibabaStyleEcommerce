...
function SupplierSignUp() {
  ...
  return (
    <div className="w-full lg:w-4/12 mx-auto mt-16 md:mt-10 mb-8 lg:px-6 bg-white  rounded-md">
        ...
        <div className='flex flex-col gap-5 mb-2'>
             ...
             {/* Email */}
                ...
                className={`py-1 ${showMoreFields ? 'order-1' : 'order-3'}`}>
                    ...
                    <div className={`transition-all duration-300 ${showMoreFields ? 'opacity-100 max-h-[1000px]' :
