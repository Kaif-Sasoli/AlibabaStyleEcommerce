...
function BlockDetail({className = ''}) {
     ...
     ${className}`}>
        ...
        {activeTab === 'Description' && (details.length > 0 || features.length > 0)  && (
             <div className='  px-4 py-5'>
              {/* Description */}
             <div>
                <p className='text-sm'>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
      ...
      {activeTab === 'About seller' && (
        <div className="px-4 py-6">
          ...
          <div className="mt-4 text-sm text-gray-700 leading-relaxed">
            We are a trusted online store with over 10 years of experience in delivering quality electronics and fashion products worldwide. Our mission is to provide affordable, high-quality goods while ensuring customer satisfaction and support.
          </div>
        </div>
      )}     
    </div>
